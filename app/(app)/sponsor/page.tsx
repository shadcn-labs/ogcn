...
export const metadata: Metadata = createPageMetadata({
  description:
    "Support ogcn — a shadcn registry of beautiful Open Graph image components. Sponsor tiers, stargazers, and how to contribute.",
  path: ROUTES.SPONSOR,
  title: "Sponsor",
});
      ...
      <section className="container-wrapper relative">
        <div className="container max-w-2xl flex flex-col items-center gap-4 py-16 text-center md:py-20 lg:py-24">
          ...
          <p className="text-base text-muted-foreground text-balance">
            ogcn is a shadcn registry of beautiful Open Graph image components.
            Every component is free and that&apos;s not changing.
          </p>
          <p className="text-sm text-muted-foreground text-balance">
            I&apos;m not going to paywall features or gate components behind a
            sponsorship tier. But if ogcn made your project better, or you just
