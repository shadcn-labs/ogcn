...
```bash
npx shadcn@latest add https://ogcn.vercel.app/r/editorial.json
```
...
| -------- | -------- | --------------------- |
| `kicker` | `string` | `"Essay"`             |
| `title`  | `string` | An example headline.  |
| `author` | `string` | `"ogcn"`              |
| `meta`   | `string` | `"Issue 04"`          |
| `ghost`  | `string` | First word of `title` |
| `accent` | `string` | `"#e11d48"`           |
