---
title: Introduction
description: ogcn is a shadcn registry of beautiful Open Graph image components built on Satori.
---

**ogcn** is a [shadcn registry](https://ui.shadcn.com/docs/registry) of beautiful
...
1. Each component lives at `registry/ogcn/<name>.tsx`
...
Absolutely. Add a file to `registry/ogcn/`, list it in `registry.json`,
