---
title: Installation
description: Install an ogcn component and render it as an Open Graph image.
---
...
ogcn is a normal shadcn registry, so you can extend it:

### 1. Add a component

Create `registry/ogcn/yours.tsx`. Use **flexbox + inline styles only** so
...
{
  "name": "ogcn",
  "homepage": "https://ogcn.vercel.app",
  "items": [
    {
      "name": "yours",
